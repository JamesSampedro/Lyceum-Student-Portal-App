...
Public Class FormModifyGrades
    ...
    Private Sub btmEdit_Click(sender As Object, e As EventArgs) Handles btmEdit.Click
        Dim conn As New OleDbConnection(cs)
        Dim edit As String = "UPDATE tblGrades SET [Semester]=@Semester, [Subject]=@Subject, [Prelim]=@Prelim, [Midterm]=@Midterm, [Final]=@Final, [Average]=@Average WHERE StudentID=@StudentID" 'database query
    ...
    Private Sub btnCalculateAvg_Click(sender As Object, e As EventArgs) Handles btnCalculateAvg.Click
        txtboxAverage.Text = ((txtboxPrelim.Text) + Val(txtboxMidterm.Text) + Val(txtboxFinals.Text)) / 3
    End Sub
